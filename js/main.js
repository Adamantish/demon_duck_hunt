...
function renderStartScreen() {
  ...
  html += "<p>Your job is to kill them ducks dead. <br> Your pleasure is to kill the already dead one deader. Double-dead it after it turns invisible for triple points.</p>"
